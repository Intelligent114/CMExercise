...
\section{作业3}
    ...
    \begin{frame}{作业3 T3}
        ...
        \pause\begin{flalign*}
            E(f)&=I(f)-S(f)=\dfrac{f^{(2n)}(\xi)}{(2n)!}\int_a^b W(x)\omega_n^2(x)\diff x&\\
                &=\dfrac{f^{(6)}(\xi)}{6!}\int_{-2}^2(x-\alpha)^2 x^2(x+\alpha)^2\diff x=\dfrac{f^{(6)}(\xi)}{6!}\int_{-2}^2(x^2-\dfrac{12}{5})^2 x^2\diff x&\\
                &=\dfrac{f^{(6)}(\xi)}{6!}\int_{-2}^2(x^6-\dfrac{24}{5}x^4+\dfrac{144}{25}x^2)\diff x&\\
                &=\dfrac{f^{(6)}(\xi)}{6!}\cdot\dfrac{1024}{175}=\dfrac{64}{7875} f^{(6)}(\xi),\xi\in[-2,2]&
        \end{flalign*}
    \end{frame}
    \begin{frame}{作业3 T4}
