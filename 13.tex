...
\section{解答}
    ...
    $\quad$直线对应约束条件，橙色区域为可行域。可行基解为$(0.5,0),(8,0),(2,3),(0,3),(0,1)$，

    $\quad$对应值为$1,16,13,9,3$，因此最优解为$(8,0)$，对应目标函数值为$16$，存在唯一最优解。

    $2.\,\,$令$x_4=x_5-x_6,x_5,x_6\geq 0$，对后两个不等式约束添加松弛变量$x_7,x_8$，则标准形式为：
    \begin{flalign*}
